...
* See [Bar file](../apiref/1.5.2/301_Bar_File.html) for details.
...
* To check the progress of the process, use [Box metadata acquisition](../apiref/1.5.2/303_Progress_of_Bar_File_Installation.html).
...
To refer to that log, use [Log file acquisition API](../apiref/1.5.2/285_Retrieve_Log_File.html) to refer to it.
